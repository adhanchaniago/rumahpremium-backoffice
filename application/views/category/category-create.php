					...
					<div class="row">
						<div class="col-8">
							<div class="breadcrumb-nav text-white mt-2 fontsize-smaller text-uppercase">
							    ...
							    <span class="mx-2">/</span>
							    <span class="text-light"><strong>Tambah Kategori</strong></span>
							</div>					
						</div>
						...
						<div class="card shadow">
							<div class="card-body">
								...
								<div class="form-group fontsize-small mb-0 clearfix">
									...
									<input type="text" class="form-control validate inputmax" id="input-category-name" data-validate="validation/required" maxlength="20" name="category_name" required>
									<div class="invalid-feedback w-75 float-left">Nama kategori wajib diisi</div>
									<small class="form-text text-muted text-right"><span class="inputmax-count">0</span>/20</small>
								</div>
								<div class="form-group fontsize-small mb-0">
									...
									<select class="form-control select-custom fontsize-small" id="input-product-sku" name="product_code[]" multiple="multiple">
										<?php foreach($product_list as $product): ?>
											<option value="Municipal Courts"><?php echo $product->product_title; ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							</div>
