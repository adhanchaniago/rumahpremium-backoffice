...
<div class="col-10">
	<?php echo form_open('product/action/create_csv',array('class'=>'product-validation','novalidate'=>'novalidate')); ?>
	<div class="row">
				...
				<div class="row">
					<div class="col-8 offset-2">
						<div class="card shadow">
							<div class="card-body">
								<h6 class="text-uppercase element-header"><strong>Unggah Produk Melalui Excel</strong></h6>
								<p class="mb-4 text-muted fontsize-smaller">Kamu dapat melakukan penambahan data menggunakan file excel yang sudah disiapkan secara template. Silahkan unduh template dan isi sesuai produk yang akan diunggah. <br><br>Setelah selesai mengisi data produk, mohon menyimpan file template tersebut dengan ekstensi .csv untuk kemudian diunggah di kolom yang disediakan di bawah ini.</p>
								<hr>
								<a href="<?php echo base_url(); ?>repository/template/template-produk.xlsx" target="_blank">
									<button type="button" class="btn btn-primary btn-sm mb-4">Unduh template produk</button>
								</a>
